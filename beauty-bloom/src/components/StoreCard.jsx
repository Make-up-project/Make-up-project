  ...
  return (
    <div className="flex flex-col bg-white shadow-md rounded-md border border-gray-300 relative">
      <img
        ...
        alt={props.name}
        className="w-full h-72 object-fill bg-cover rounded-t-md"
      />
      ...
      <div className="flex justify-between gap-3 items-end p-3 justify-self-end mt-auto">
        ...
        <button
          className="flex-shrink-0 w-12 h-12 rounded-full bg-pink-100 cursor-pointer flex items-center justify-center"
